...
class BlackJack{
    ...
    public static void main(String[] args) throws Exception //lisasin "throws Exception"
    {
     ...
     System.out.println();
        ...
        if (player_preference.equals("stay"))
        {
			...
			for (int i = 0; i < 100; i++){
			  ...
			  PrintWriter writer = new PrintWriter(new FileWriter("kokku.txt"));
				//for (int i = 0; i < 100; i++){
			  writer.println("Mängija punktid on " +player_total);
			  writer.println();
			  writer.println("Diileri punktid on " +dealer_total);
			  writer.println();
			  writer.println("võitja  on " +winner);
			//}
			writer.close();
			}
